...
export const Button = ({ children, type="default", ...props }: IButton): React.ReactNode => {
  const styles = {
    ...
    outline: "border-1 border-gray-500 text-gray-600 hover:border-gray-900 hover:text-gray-900",
    flat: "shadow-gray-400 border-1 border-transparent",
    danger: "bg-red-500 hover:bg-red-600 text-white",
    secondaryDanger: "bg-red-100 text-red-800 hover:bg-red-200",
    outlineDanger: "text-red-500 hover:border-red-600 hover:text-red-600 shadow-red-600 border-1",
    ...
    outlineAccept: "text-green-500 hover:border-green-600 hover:text-green-600 shadow-green-200 border-1",
